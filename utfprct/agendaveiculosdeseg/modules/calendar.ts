...
const FALLBACK_SITUACOES: AgendaSituacao[] = [
  ...
  { chave: 'aguardando_finalizacao',   nome_display: 'Aguardando Finalização',       descricao: 'Saídas com situação "Liberada pelo Disau" cuja saída já passou do dia e hora atual', cor_fundo: '#59647a', cor_borda: '#414a5d', cor_texto: '#fff', icone: 'fa-hourglass-half',     ordem: 2 },
